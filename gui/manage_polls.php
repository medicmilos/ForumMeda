	...
	if(isset($_REQUEST['delete'])){
		...
		if($levo<0){
			...
			if(($ukupno_zapisa-$skriveno)<=$koliko_po_strani){
				...
				$xyz="<td></td><td></td><td></td><td></td><td width=\"50px\"><a class='naprednazad' href=\"index.php?page=18&skriveno=$desno\"> Forward</a>";
			}
			
			
		}elseif($desno >= $ukupno_zapisa){
			$xyz="<td><a href=\"index.php?page=18&skriveno=$levo\"  class='naprednazad' > Back </a></td><td></td><td></td><td></td><td width=\"50px\"> ";
		}else {
			$xyz="<td><a href=\"index.php?page=18&skriveno=$levo\" class='naprednazad' > Back </a></td><td></td><td></td><td></td><td width=\"50px\"><a href=\"index.php?page=18&skriveno=$desno\" class='naprednazad' > Forward </a>";
		}
		...
		$upit = "SELECT * FROM poll LIMIT $koliko_po_strani OFFSET $skriveno";
			...
			while($red = mysql_fetch_array($rezultat)){  
				...
				echo("<tr>
					...
					<td id='xmark1'><a href='index.php?page=19&id=$idcomment'>&#9997;</a></td>
					<td id='xmark2'><a href='index.php?page=18&delete=$idcomment'>&#10006;</a></td>
				</tr>"); 
			}
			echo("</table></form>");
